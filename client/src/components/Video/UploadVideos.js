          ...
          >
            <div className="w-full h-100">
              ...
              <form className="mt-6" onSubmit={handleSubmit}>
                ...
                <div className="mt-4">
                  <label className="block text-gray-700">GroupId(1,2,3)</label>
                  <input
                    type="number"
                    name="group"
                ...
                <input
                  onChange={() => {
                    ...
                    uploadVideo(file, videoInformation, groupId);
                  }}
                  ref={ref}
                ...
                <Button
                  ...
                  Prop={{
                    onClick: () =>
                      !upload && ref.current && ref.current.click(),
                    disabled: upload,
                  }}
              ...
              {
                <button
                  className="w-full mt-5 block bg-blue-600 hover:bg-grap-100 rounded-lg px-4 py-3 border border-gray-300 text-white"
